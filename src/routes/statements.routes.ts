...
import { TransferToUserController } from '../modules/statements/useCases/transferToUser/TransferToUserController';
...
const transferToUserController = new TransferToUserController();
...
statementRouter.post('/transfers/:user_id', transferToUserController.execute);
